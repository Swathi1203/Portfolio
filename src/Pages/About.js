    ...
    <section className="min-h-[90vh] sm:flex items-center">
      <div className="sm:w-[50%]  py-[50px] p-6">
        ...
        <p data-aos="fade-up" className="pl-3 font-serif">
          ...
          visually appealing web solutions. Proficient in front-end and basics in back-end
          development, utilizing HTML, CSS, JavaScript, React,mysql ,php.
           Skilled inbuilding responsive interfaces, optimizing website performance, and
