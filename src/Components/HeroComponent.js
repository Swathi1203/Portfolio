      ...
      <div className="md:flex-row flex flex-col-reverse w-full min-h-[90vh] items-center">
        ...
        <div className="md:w-[60%] flex flex-col gap-4 items-center py-[50px] px-2 md:items-start">
          ...
          >
            <Typewriter
              options={{
                strings: ["swathi singh", "WEB DEVELOPER",],
                autoStart: true,
                loop: true,
              }}
            />
          ...
          >
            A active learner and team player, I strive for user-centered
            design. Let's build something amazing together!
          </p>
          <div className="flex gap-4 flex-col sm:flex-row">
          <div className="flex gap-4 flex-col sm:flex-row">
    <a
      href="https://drive.google.com/file/d/1xqRocDGsbQw38t-fq021RXMTPDW5Xpf4/view?usp=sharing"
      download="https://drive.google.com/file/d/1xqRocDGsbQw38t-fq021RXMTPDW5Xpf4/view?usp=sharing"
      target="_blank" // Add this attribute to open the link in another page
